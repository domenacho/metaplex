...
async function setCollection(walletKeyPair, anchorProgram, candyMachineAddress, collectionMint) {
    ...
    loglevel_1.default.info('Metadata authority: ', wallet.publicKey.toBase58());
    loglevel_1.default.info('Master edition address: ', masterEditionPubkey.toBase58());
    loglevel_1.default.info('Mint address: ', mintPubkey.toBase58());
