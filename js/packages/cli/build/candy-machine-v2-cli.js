...
programCommand('upload')
    ...
    .option('-nc, --no-collection', 'optional flag to prevent the candy machine from using an on chain collection')
    ...
    const collectionMintPubkey = (0, various_1.parseCollectionMintPubkey)(collectionMint);
...
programCommand('withdraw_bundlr').action(async (_, cmd) => {
    ...
    const walletKeyPair = (0, accounts_1.loadWalletKey)(keypair);
    await (0, arweave_bundle_1.withdraw_bundlr)(walletKeyPair);
});
commander_1.program
